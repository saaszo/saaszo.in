        ...
        <div className="relative z-10 animate-fade-up">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-xl text-on-surface-variant leading-relaxed">
              The ethereal workspace designed for clarity, precision, and
              uncompromised scale.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex gap-4 items-start group">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Seamlessly integrate your disparate workflows into a singular,
                unified sanctuary.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start group">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Uncompromising data protection built into the foundation of your
                digital environment.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start group">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Transform raw data into actionable architectural insights in
                real-time.
              </p>
            </div>
          </div>
