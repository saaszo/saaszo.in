...
const FAQS = [
  ...
  },
  {
    ...
    a: "No. That's the entire point of SaaSzo. One account, one login, instant SSO access to all five products. Open Invoice, Task Manager, Seller Hub, HRMS, or Engage from your dashboard — no extra passwords, no re-authentication.",
  },
  {
