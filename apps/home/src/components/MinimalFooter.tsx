      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="#solutions" className="hover:text-[#6451f1] transition-colors">Retail &amp; Supermarket</a></li>
              <li><a href="#solutions" className="hover:text-[#6451f1] transition-colors">Wholesale &amp; Distribution</a></li>
              <li><a href="#solutions" className="hover:text-[#6451f1] transition-colors">Pharmacy &amp; Chemist</a></li>
              <li><a href="#solutions" className="hover:text-[#6451f1] transition-colors">Electronics &amp; Hardware</a></li>
              <li><a href="#solutions" className="hover:text-[#6451f1] transition-colors">Services &amp; Agencies</a></li>
            </ul>
          </div>
