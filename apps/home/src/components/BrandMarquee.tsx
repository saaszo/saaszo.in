  ...
  return (
    <section className="py-20 md:py-28 bg-slate-50/60 overflow-hidden border-y border-slate-200/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-block text-xs font-black tracking-widest text-[#6451f1] uppercase mb-3">
          TRUSTED BY THE BEST
        </div>
      ...
      <div className="mt-14 max-w-6xl mx-auto px-4 relative">
        ...
        <div className="relative flex justify-center mb-8">
          <div className="relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white border-2 border-[#6451f1] shadow-2xl shadow-indigo-500/20 z-10">
            ...
            <div className="text-left">
              <div className="text-lg font-black tracking-tight text-slate-950">
                SAASZO <span className="text-[#6451f1]">POS</span>
              </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          {brandsRow1.map((b) => (
            <div
              key={b.name}
              className="flex items-center gap-3 px-5 py-3 rounded-full bg-white border border-slate-200 shadow-xs hover:border-[#6451f1] hover:shadow-md transition-all duration-200 group cursor-default"
            >
              <div className="w-2.5 h-2.5 rounded-full bg-[#6451f1] group-hover:scale-125 transition-transform" />
              <div className="text-sm font-bold text-slate-900 group-hover:text-[#6451f1] transition-colors">
                {b.name}
              </div>
