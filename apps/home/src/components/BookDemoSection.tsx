        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-slate-50/70 rounded-3xl p-6 sm:p-12 border border-slate-200/90 shadow-xl">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1.5">
                      Name<span className="text-[#6451f1]">*</span>
                    </label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#6451f1] focus:border-[#6451f1] shadow-xs"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1.5">
                      Email<span className="text-[#6451f1]">*</span>
                    </label>
                    <input
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1.5">
                      Phone number<span className="text-[#6451f1]">*</span>
                    </label>
                    <div className="flex">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-r-xl bg-white border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#6451f1] focus:border-[#6451f1] shadow-xs"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1.5">
                      City<span className="text-[#6451f1]">*</span>
                    </label>
                    <input
                      type="text"
                      required
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">
                    Business Name<span className="text-[#6451f1]">*</span>
                  </label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-2">
                    Which product are you interested in?<span className="text-[#6451f1]">*</span>
                  </label>
                    ...
                    {products.map((p) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs font-bold transition-all cursor-pointer ${
                          selectedProduct === p
                            ? "bg-[#6451f1] text-white shadow-xs"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-4 rounded-xl bg-[#6451f1] hover:bg-[#5340e6] text-white font-bold text-sm tracking-wide shadow-lg shadow-indigo-500/25 transition-all duration-200 cursor-pointer"
                  >
                    Submit Demo Request
                  </button>
                </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="mt-4 flex items-center gap-2 text-xs font-bold text-slate-600">
              <Headphones className="w-4 h-4 text-[#6451f1]" />
